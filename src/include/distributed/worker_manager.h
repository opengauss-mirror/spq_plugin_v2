...
typedef struct WorkerNode {
    ...
    bool shouldHaveShards; /* if the node should have distributed table shards on it or
                              not */
} WorkerNode;
...
extern List* ActivePrimaryNodeListForRead(LOCKMODE lockMode);
...
extern WorkerNode* SetWorkerColumnOptional(WorkerNode* workerNode, int columnIndex,
                                           Datum value);
