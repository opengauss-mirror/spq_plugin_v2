...
/** RawStmt is not supportted in openGauss */
using RawStmt = Node;
...
extern TupleTableSlot* CitusExecScan(ExtensiblePlanState* node);
extern TupleTableSlot* ReturnTupleFromTuplestore(CitusScanState* scanState);
extern void ReadFileIntoTupleStore(char* fileName, char* copyFormat,
...
extern void ExecuteQueryStringIntoDestReceiver(const char* queryString,
...
struct SessionExecutorCtx {
     ...
     */
    ParamListInfo executorBoundParams{nullptr};
    ...
    List* CreatedResultsDirectories{NIL};
};
